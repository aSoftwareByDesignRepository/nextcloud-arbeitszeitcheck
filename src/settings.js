/**
 * Personal settings JavaScript entry point for ArbeitszeitCheck
 *
...
const mountPoint = document.querySelector('#arbeitszeitcheck-personal-settings')
if (mountPoint) {
	...
	console.error('Mount point #arbeitszeitcheck-personal-settings not found')
}