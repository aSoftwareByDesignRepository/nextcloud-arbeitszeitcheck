/**
 * Compliance violations JavaScript entry point for ArbeitszeitCheck
 *
...
import ComplianceViolations from './views/ComplianceViolations.vue'
import { translate } from '@nextcloud/l10n'
import './styles/main.css'

const mountPoint = document.querySelector('#arbeitszeitcheck-content')
if (mountPoint) {
	const app = createApp(ComplianceViolations)
