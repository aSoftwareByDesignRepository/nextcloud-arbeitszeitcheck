/**
 * Manager dashboard JavaScript entry point for ArbeitszeitCheck
 *
...
const mountPoint = document.querySelector('#arbeitszeitcheck-manager-dashboard')
if (mountPoint) {
	const app = createApp(ManagerDashboard)
	...
	console.error('Mount point #arbeitszeitcheck-manager-dashboard not found')
}
