...
// Script loading is now handled in ManagerController::dashboard() using Util::addScript()
...
<div id="arbeitszeitcheck-manager-dashboard" class="timetracking-manager-dashboard"></div>
