...
window.ArbeitszeitCheck = window.ArbeitszeitCheck || {};
    ...
    window.ArbeitszeitCheck.l10n.unsavedChangesTitle = <?php echo json_encode($l->t('Unsaved changes'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.leaveWithoutSaving = <?php echo json_encode($l->t('Leave without saving'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.stayOnPage = <?php echo json_encode($l->t('Stay on page'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.selectPerson = <?php echo json_encode($l->t('Select'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.select = <?php echo json_encode($l->t('Select'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    ...
    /* Bulk apply (admin users multi-select) — keys used by auMsg() in admin-users.js */
    window.ArbeitszeitCheck.l10n.holidayRegion = <?php echo json_encode($l->t('Holiday region'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.confirmApply = <?php echo json_encode($l->t('Confirm apply'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.preview = <?php echo json_encode($l->t('Preview'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.done = <?php echo json_encode($l->t('Done'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.bulkApplyHelp = <?php echo json_encode($l->t('Apply the same work schedule and/or holiday region to the selected people.'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.vacationRecommended = <?php echo json_encode($l->t('Recommended for vacation'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.vacationL2Hint = <?php echo json_encode($l->t('Put people on a team and use team vacation rules (L2).'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.openTeams = <?php echo json_encode($l->t('Open teams'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.vacationAdvanced = <?php echo json_encode($l->t('Advanced: same personal vacation rule (L3)'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.vacationL3Hint = <?php echo json_encode($l->t('Only for exceptions that are not modeled as a team.'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.noChange = <?php echo json_encode($l->t('— no change —'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.useOrgDefault = <?php echo json_encode($l->t('Use organisation default'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.applyToSelected = <?php echo json_encode($l->t('Apply to selected…'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.nSelectedApply = <?php echo json_encode(TemplateL10n::translate($l, '%n selected — Apply…'), TemplateL10n::JSON_ENCODE_FLAGS); ?>;
    window.ArbeitszeitCheck.l10n.selectPeopleFirst = <?php echo json_encode($l->t('Select at least one person.'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.chooseField = <?php echo json_encode($l->t('Choose a work schedule and/or holiday region.'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.previewSummary = <?php echo json_encode(TemplateL10n::translate($l, 'Would update %1$d people (%2$d failed checks).'), TemplateL10n::JSON_ENCODE_FLAGS); ?>;
    window.ArbeitszeitCheck.l10n.confirmBulk = <?php echo json_encode(TemplateL10n::translate($l, 'Apply these settings to %n people?'), TemplateL10n::JSON_ENCODE_FLAGS); ?>;
    window.ArbeitszeitCheck.l10n.bulkDone = <?php echo json_encode(TemplateL10n::translate($l, 'Updated %1$d, failed %2$d.'), TemplateL10n::JSON_ENCODE_FLAGS); ?>;
    window.ArbeitszeitCheck.l10n.l3Done = <?php echo json_encode(TemplateL10n::translate($l, 'L3 vacation: updated %1$d, failed %2$d.'), TemplateL10n::JSON_ENCODE_FLAGS); ?>;
    window.ArbeitszeitCheck.l10n.bulkFailed = <?php echo json_encode($l->t('Bulk update failed'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.previewFailed = <?php echo json_encode($l->t('Preview failed'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.errorLoadingModels = <?php echo json_encode($l->t('Could not load working time models'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.selectAllPage = <?php echo json_encode($l->t('Select all on this page'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    window.ArbeitszeitCheck.l10n.clearSelection = <?php echo json_encode($l->t('Clear selection'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
